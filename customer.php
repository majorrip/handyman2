...
if(isset($_POST['submit']))
{
	if(isset($_GET['editid']))
	{
		...
		$sql = "UPDATE customer SET customer_fname='$_POST[customer_fname]',customer_lname='$_POST[customer_lname]',email_id='$_POST[email_id]',password='$_POST[password]',address='$_POST[address]',state='$_POST[state]',city='$_POST[city]',landmark='$_POST[landmark]',mobile_no='$_POST[mobile_no]',note='$_POST[note]',status='$_POST[status]' WHERE  customer_id='$_GET[editid]'";
	...
	{
	$sql = "INSERT INTO customer(customer_fname,customer_lname,email_id,password,address,state,city,landmark,pincode,mobile_no,note,status) VALUES('$_POST[customer_fname]','$_POST[customer_lname]','$_POST[email_id]','$_POST[password]','$_POST[address]','$_POST[state]','$_POST[city]','$_POST[landmark]','$_POST[pincode]','$_POST[mobile_no]','$_POST[note]','$_POST[status]')";
	$qsql = mysqli_query($con,$sql);
	if(mysqli_affected_rows($con) == 1)
	{
...
<div class="col-lg-12">
	<p class="single-form-row">
		<label>First Name</label> <span class="errormsg"  id="errcustomer_fname"></span>
		<input type="text" name="customer_fname" id="customer_fname" class="form-control" value="<?php echo $rsedit['customer_fname']; ?>" >
	</p>
</div>		
<div class="col-lg-12">
	<p class="single-form-row">
		<label>Last Name</label> <span class="errormsg"  id="errcustomer_lname"></span>
		<input type="text" name="customer_lname" id="customer_lname" class="form-control" value="<?php echo $rsedit['customer_lname']; ?>" >
	</p>
</div>	
