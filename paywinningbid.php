...
?>
        ...
        <div class="col-md-6 col-sm-6 ">
            <div class="product-grid8 border">
                ...
                <div class="product-content">
                    <span class="product-shipping" style="color: green;"><b>Winner : <?php echo $rsproduct['customer_fname']; ?> <?php echo $rsproduct['customer_lname']; ?></b></span>
	...
	<div class="col-md-12 col-sm-12 "><hr><center><h3>Payment Panel</h3></center><hr></div>
        <div class="col-md-6 col-sm-6 ">
            <div class="col-md-12">
				...
				<input name="custname" class="form-control" type="text" readonly value='<?php echo $rscustomer['customer_fname']; ?> <?php echo $rscustomer['customer_lname']; ?>'>
				<br>
            </div>
            <div class="col-md-12">
