...
{
	$sql = "UPDATE employee SET password='$_POST[npass]' WHERE employee_id='$_SESSION[employee_id]' AND password='$_POST[opass]'";
...
<button class="btn btn-info" type="submit" name="submit">Update Password</button>
										</div>
									</section>
								</form>
