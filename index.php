...
<!-- Timer code ends here -->
				<div class="price-box">
					<span class="new-price">Current Bid Amount : <?php echo $currencysymbol; ?><?php 
...
<!-- Timer code ends here -->
	...
	<!-- single-product-wrap end -->
			...
			<a href="https://www.youtube.com/watch?v=4cB2wMQNAss&list=PL-YAtWD_fyVlH3sx4agLca-_zT1eri16m" target="_blank" style="text-decoration: none; display: block; width: 75%;">
    <button type="button" class="btn btn-danger w-100 py-2 rounded-1 text-uppercase fw-bold" style="background-color: #FF0000; width: 100%;">
        <i class="fa fa-youtube"></i>
        Check out Handy Man videos
    </button>
</a>
