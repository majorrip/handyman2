...
?>
	<a href="" class="chatperson" onclick="return false;">
		...
		<div class="namechat">
			<div class="pname"><?php echo $rsmessage['customer_fname']; ?> <?php echo $rsmessage['customer_lname']; ?></div>
...
?>
	<a href="" class="chatperson" onclick="return false;">
		<div class="namechat">
			<div class="pname"><?php echo $rsmessage['customer_fname']; ?> <?php echo $rsmessage['customer_lname']; ?> - <span font-size='font-size:9px;'><?php echo date("d-M-Y h:i A",strtotime($rsmessage['message_date_time'])); ?></span></div>
			<div class="lastmsg"><?php echo $rsmessage['message'] ?></div>
		</div>
	</a>
<?php
