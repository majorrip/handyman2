...
<div class="description-content">
	...
	<?php
		...
		else
		{
			...
			{
			echo $rsedit['bidding_id'] . "-" . $rsedit['customer_fname'] ." " . $rsedit['customer_lname'] . " bidded $currencysymbol XXXX on " . date("d-M-Y h:i A",strtotime($rsedit['bidding_date_time'])) ."<hr>";
			}
		}
	?>
	</p>
