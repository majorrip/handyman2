                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="about-us-footer">
                                    ...
                                    <div class="footer-info">
                                        <p class="phone">Phone number here</p>
                                    </div>
                                </div>
                            </div>
...
?>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> Handy Man<br>Address.<br>Bangladesh</p>
                                                <p>Call us: <span>Phone number </span></p>
                                                <p>Email us: <span>contact@handyman.com</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Copyright &copy; Handy Man. All Rights Reserved</div>
                            </div>	
                            <div class="col-lg-6 col-md-6">
